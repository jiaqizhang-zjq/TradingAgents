...
def create_bear_researcher(llm, memory):
    def bear_node(state) -> dict:
        ...
        # 获取特定股票的胜率
        symbol_win_rate = tracker.get_researcher_win_rate("bear_researcher", symbol, default_win_rate=0.48)
        # 获取研究员平均胜率
        avg_win_rate = tracker.get_researcher_win_rate("bear_researcher", None, default_win_rate=0.48)
...
"""
        ...
        round_argument = f"## 第 {current_round} 轮 - 空头观点\n{argument}"
